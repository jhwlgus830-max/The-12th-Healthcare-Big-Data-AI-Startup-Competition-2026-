...
export const clients = [
  { 
    ...
    phq9: 22, 
    p4: 3, 
    summary: "최근 자살충동 및 우울감 수치 급증. 챗봇 대화에서 직접적 위험 표현 빈번하게 감지됨. 집중 관리 필요.", 
    updated: "10분 전" 
  },
  { 
    id: "user-004", 
    ...
    phq9: 17, 
    p4: 2, 
    summary: "자살사고 감지. PHQ-9 17점으로 높은 우울 수준 보고. 집중 모니터링 대상으로 분류됨.", 
    updated: "2시간 전" 
  },
  { 
    id: "user-002", 
    ...
    phq9: 13, 
    p4: 0, 
    summary: "직장 및 대인관계 스트레스로 우울감 상승세. 무기력함을 호소하고 있음.", 
    updated: "4시간 전" 
  },
  { 
    id: "user-001", 
    ...
    phq9: 6, 
    p4: 0, 
    summary: "일상적 돌봄 대상. 취업 준비 스트레스와 가벼운 무기력, 당위적 인지 왜곡 관찰됨.", 
    updated: "1일 전" 
  },
  { 
    id: "user-005", 
    ...
    phq9: 3, 
    p4: 0, 
    summary: "최소 수준의 우울. 정서적으로 안정된 편이며 또치 페르소나와 자기보고식 일상 관리 중.", 
    updated: "3일 전" 
  }
];
