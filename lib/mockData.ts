...
export const phq9ResultConfig = {
  ...
  high: {
    ...
    desc: "당신의 안전을 위해 위기 대응 모드로 전환합니다. 구조봇이 긴급 지원 절차를 안내하고 곁을 지켜드릴게요.",
    buttonText: "구조봇과 안전 가이드 시작하기 →",
    persona: 3 as const, // 구조봇 (Aligned to 3)
    bgColor: "bg-[#1A2744]",
