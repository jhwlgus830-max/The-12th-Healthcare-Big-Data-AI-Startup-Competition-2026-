          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex justify-between items-center">
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <span className={`px-2 py-0.5 text-xs font-bold rounded-full ${
                    client.risk === 'High' ? 'bg-red-100 text-red-600 animate-pulse' : 'bg-green-100 text-green-600'
                  }`}>
            ...
            <div className="flex gap-3">
              ...
              <button 
                ...
                className="flex items-center gap-2 px-4 py-2.5 bg-[#1E2D4E] text-white rounded-xl text-sm font-bold hover:bg-[#2D4A7A] transition-colors shadow-sm"
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-8 bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
              <h3 className="font-bold text-gray-800 mb-6 flex items-center gap-2">
                <TrendingUp size={18} className="text-[#6096C8]" /> 감정 변화 추세 (누적 진단 이력)
              </h3>
              <div className="h-64">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-7 bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
              ...
              <div className="space-y-3 max-h-64 overflow-y-auto pr-1">
                {mappedRiskLogs.length === 0 ? (
                  <p className="text-sm text-gray-400 text-center py-8">감지된 자살/자해 고위험 위험 표현이 없습니다.</p>
                ) : (
                  mappedRiskLogs.map((log, i) => (
                    <div key={i} className="p-3 bg-red-50/40 rounded-xl flex justify-between items-center border border-red-100/60">
            ...
            <div className="lg:col-span-5 bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
              <h3 className="font-bold text-gray-800 mb-2 flex items-center gap-2">
                <PieChart size={18} className="text-[#6096C8]" /> 감정 분포 (실시간 대화 분석)
              </h3>
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex justify-between items-center">
            ...
            <div className="flex gap-2">
              ...
              <button 
                ...
                className="flex items-center gap-2 px-4 py-2 bg-[#1E2D4E] text-white rounded-xl text-sm font-bold hover:bg-[#2D4A7A] transition-colors shadow-sm"
              >
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex gap-2">
              ...
              <button 
                ...
                className="flex items-center gap-2 px-4 py-2 bg-[#1E2D4E] text-white rounded-xl text-sm font-bold hover:bg-[#2D4A7A] transition-colors"
              >
                <Plus size={16} /> 노트 추가
              </button>
            </div>
            ...
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
              ...
              <div className="space-y-4 max-h-72 overflow-y-auto pr-1">
                {detectedPhrases.length === 0 ? (
                  <p className="text-sm text-gray-400 text-center py-8">이번 유형으로 탐지된 내담자 대화 기록이 없습니다.</p>
                ) : (
